...
const Matrix Matrix::Identity(__identity);
...
const Matrix Matrix::Zero(__zero);
...
{
	// I'm_m sure this can be optimized!

	Matrix tmp;
	// Col-Major = Col-Major * Col-Major
	tmp.m_m[ 0] = m_m[ 0]*_m.m_m[ 0] + m_m[ 4]*_m.m_m[ 1] + m_m[ 8]*_m.m_m[ 2] + m_m[12]*_m.m_m[ 3];
	tmp.m_m[ 1] = m_m[ 1]*_m.m_m[ 0] + m_m[ 5]*_m.m_m[ 1] + m_m[ 9]*_m.m_m[ 2] + m_m[13]*_m.m_m[ 3];
	tmp.m_m[ 2] = m_m[ 2]*_m.m_m[ 0] + m_m[ 6]*_m.m_m[ 1] + m_m[10]*_m.m_m[ 2] + m_m[14]*_m.m_m[ 3];
	tmp.m_m[ 3] = m_m[ 3]*_m.m_m[ 0] + m_m[ 7]*_m.m_m[ 1] + m_m[11]*_m.m_m[ 2] + m_m[15]*_m.m_m[ 3];

	tmp.m_m[ 4] = m_m[ 0]*_m.m_m[ 4] + m_m[ 4]*_m.m_m[ 5] + m_m[ 8]*_m.m_m[ 6] + m_m[12]*_m.m_m[ 7];
	tmp.m_m[ 5] = m_m[ 1]*_m.m_m[ 4] + m_m[ 5]*_m.m_m[ 5] + m_m[ 9]*_m.m_m[ 6] + m_m[13]*_m.m_m[ 7];
	tmp.m_m[ 6] = m_m[ 2]*_m.m_m[ 4] + m_m[ 6]*_m.m_m[ 5] + m_m[10]*_m.m_m[ 6] + m_m[14]*_m.m_m[ 7];
	tmp.m_m[ 7] = m_m[ 3]*_m.m_m[ 4] + m_m[ 7]*_m.m_m[ 5] + m_m[11]*_m.m_m[ 6] + m_m[15]*_m.m_m[ 7];

	tmp.m_m[ 8] = m_m[ 0]*_m.m_m[ 8] + m_m[ 4]*_m.m_m[ 9] + m_m[ 8]*_m.m_m[10] + m_m[12]*_m.m_m[11];
	tmp.m_m[ 9] = m_m[ 1]*_m.m_m[ 8] + m_m[ 5]*_m.m_m[ 9] + m_m[ 9]*_m.m_m[10] + m_m[13]*_m.m_m[11];
	tmp.m_m[10] = m_m[ 2]*_m.m_m[ 8] + m_m[ 6]*_m.m_m[ 9] + m_m[10]*_m.m_m[10] + m_m[14]*_m.m_m[11];
	tmp.m_m[11] = m_m[ 3]*_m.m_m[ 8] + m_m[ 7]*_m.m_m[ 9] + m_m[11]*_m.m_m[10] + m_m[15]*_m.m_m[11];

	tmp.m_m[12] = m_m[ 0]*_m.m_m[12] + m_m[ 4]*_m.m_m[13] + m_m[ 8]*_m.m_m[14] + m_m[12]*_m.m_m[15];
	tmp.m_m[13] = m_m[ 1]*_m.m_m[12] + m_m[ 5]*_m.m_m[13] + m_m[ 9]*_m.m_m[14] + m_m[13]*_m.m_m[15];
	tmp.m_m[14] = m_m[ 2]*_m.m_m[12] + m_m[ 6]*_m.m_m[13] + m_m[10]*_m.m_m[14] + m_m[14]*_m.m_m[15];
	tmp.m_m[15] = m_m[ 3]*_m.m_m[12] + m_m[ 7]*_m.m_m[13] + m_m[11]*_m.m_m[14] + m_m[15]*_m.m_m[15];

	memcpy(m_m, tmp.m_m, sizeof(float)*16);
	return *this;
}
